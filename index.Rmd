...
Prior to entering the private sector, I worked as a Statistician for [the Ontario Ministry of the Solicitor General](https://www.mcscs.jus.gov.on.ca/english/default.html)'s law enforcement branch - [the Ontario Provincial Police](https://www.opp.ca/). Before that, I was a Project Manager and an Embedded Research Analyst at [the University of Chicago Crime & Education Labs](https://urbanlabs.uchicago.edu/) consulting for the Chicago Police Department, the Chicago Mayor's Office, and a number of public agencies and outreach organizations on data analytics, policy analysis, and change management. 
